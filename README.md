...
| ---------------------------------------------------- | ------------------------------------------------------------------------------ |
| [Lazy](https://github.com/folke/lazy.nvim)           | <pre>{<br/>    "NeogitOrg/neogit",<br/>    dependencies = "nvim-lua/plenary.nvim",<br/>    config = function()<br/>        require("neogit").setup({})<br/>    end,<br/>},<br/></pre>|
