...
function M.setup(config)
  ...
  hl_store = {
    ...
    NeogitHunkMergeHEAD             = { fg = palette.bg2, bg = palette.grey, bold = false, ctermfg = 4 },
    NeogitHunkMergeHEADHighlight    = { fg = palette.bg0, bg = palette.bg_cyan, bold = palette.bold, ctermfg = 4 },
    NeogitHunkMergeHEADCursor       = { fg = palette.bg0, bg = palette.bg_cyan, bold = palette.bold, ctermfg = 4 },

    NeogitHunkMergeHEADadd          = { fg = palette.bg_green, bg = palette.line_green, ctermfg = 4 },
    NeogitHunkMergeHEADaddHighlight = { fg = palette.bg_green, bg = palette.green, ctermfg = 4 },
    NeogitHunkMergeHEADaddCursor    = { fg = palette.bg1, bg = palette.green, ctermfg = 4 },


    NeogitHunkMergeBASE              = { fg = palette.bg2, bg = palette.grey, bold = false, ctermfg = 4 },
    NeogitHunkMergeBASEHighlight     = { fg = palette.bg0, bg = palette.bg_purple, bold = palette.bold, ctermfg = 4 },
    NeogitHunkMergeBASECursor        = { fg = palette.bg0, bg = palette.bg_purple, bold = palette.bold, ctermfg = 4 },

    NeogitHunkMergeINCOMING          = { fg = palette.bg2, bg = palette.grey, bold = false, ctermfg = 4 },
    NeogitHunkMergeINCOMINGHighlight = { fg = palette.bg0, bg = palette.bg_green, bold = palette.bold, ctermfg = 4 },
    NeogitHunkMergeINCOMINGCursor    = { fg = palette.bg0, bg = palette.bg_green, bold = palette.bold, ctermfg = 4 },
