...
function M.setup()
  ...
  hl_store = {
    ...
    NeogitChangeA = { link = "NeogitChangeNewFile" },
    NeogitChangeD = { link = "NeogitChangeDeleted" },
    NeogitChangeC = { link = "NeogitChangeCopied" },
    NeogitChangeU = { link = "NeogitChangeUpdated" },
    NeogitChangeR = { link = "NeogitChangeRenamed" },
    NeogitChangeDD = { link = "NeogitChangeUnmerged" },
    ...
    NeogitChangeAU = { link = "NeogitChangeUnmerged" },
    NeogitChangeUA = { link = "NeogitChangeUnmerged" },
    NeogitChangeUntracked = { fg = "None" },
